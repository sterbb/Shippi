...
<body onload="displayDT()">
    ...
    <div class="container">
        ...
        <div class="right-side">
                ...
                <h2 class="admintxt"><i class="fas fa-user-shield" ></i>&nbsp; ADMIN</h2>
                ...
                <a href="login.php"><button class="btn2"><i class="fas fa-shopping-cart"></i></button></a>
        </div>
